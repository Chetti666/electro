...
export default function Calculadoras() {
  const calculadoras: Calculadora[] = [
    ...
    {
      id: 'rotuladora',
      title: 'Generador de rotulos de tableros eléctricos',
      description: 'Genera rotulos personalizados para tableros eléctricos según normativas vigentes. Descargalo directamente o imprimelo en pdf.',
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" />
      ...
      description: 'Genera presupuestos detallados para tus trabajos y exportalos en formato PDF de manera rápida y sencilla.',
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" />
