          ...
          <div className="card">
            ...
            {resultado !== null && (
              <div className="mt-6 text-center bg-green-100 dark:bg-green-900/30 p-4 rounded-lg border border-green-200 dark:border-green-700">
                <p className="text-base sm:text-lg text-gray-800 dark:text-gray-200">La sección del conductor requerida es:</p>
                <p className="text-2xl sm:text-3xl font-bold text-green-700 dark:text-green-400">{resultado.toFixed(4)} mm²</p>
              </div>
            )}
              ...
              {history.length === 0 ? (
                ...
                history.map((item) => (
                  <div key={item.id} className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border dark:border-gray-700">
                    <p className="font-semibold text-base sm:text-lg text-blue-600 dark:text-blue-400">{item.resultado.toFixed(4)} mm²</p>
